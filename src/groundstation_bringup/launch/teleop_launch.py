...
#
# Derived from adityakamath/akros2_teleop (launch/teleop_launch.py).
# Modifications by UWRobotics for the Sparky ground station:
#   - launch files and config are sourced from this package
#     (groundstation_bringup) instead of akros2_teleop, so controller tuning
#     lives in our own repo while the node executables stay in the submodule.
#   - default joy_config is 'ps4' (DualShock4).
