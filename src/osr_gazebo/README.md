...
This package is licensed under the **Apache License, Version 2.0** (see [LICENSE](./LICENSE)).

It is derived from:
- **NASA JPL Open Source Rover** — https://github.com/nasa-jpl/osr-rover-code — Copyright 2018 California Institute of Technology, Apache-2.0 ("Government Sponsorship Acknowledged").
- **dongjineee/rover_gazebo** — https://github.com/dongjineee/rover_gazebo — original Gazebo/RViz simulation package.

Adapted by UWRobotics for the Sparky CIRC 2026 rover. Changes are tracked in this repository's git history.
