...
def generate_launch_description():
    ...
    # Parse URDF with Gazebo hardware (use_odrive=false)
    doc = xacro.parse(open(os.path.join(osr_pkg, 'urdf', 'osr.urdf.xacro')))
    xacro.process_doc(doc, mappings={'use_odrive': 'false'})
    ...
    # Load controllers after the robot has been spawned in Gazebo
